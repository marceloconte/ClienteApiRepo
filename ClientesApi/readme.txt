O desafio é uma avaliação técnica e sua missão é desenvolver a API Clientes. Essa API deve disponibilizar o CRUD de clientes e o CRUD de Endereços como recurso da API. Obedeça a arquitetura REST e utilize rotas para estabelecer a API e seu recurso. 
...
Você tem até o dia 24/07 para realização do desafio.

Ao término, favor notificar o usuário asmmartins, nos enviando o endereço do repositório onde seu projeto está publicado.
